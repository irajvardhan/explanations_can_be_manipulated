...
def main():
    ...
    argparser.add_argument('--adv_dir', type=str, default='../../xai-adv/data/postndss/defender/fmnist/target_next/target_6/cwl2/conf_0/', help='directory to load adv samples from')
    ...
    if not input_is_adv:
        ...
        x_train = np.load(args.adv_dir + '/x_adv_ar.npy')
    ...
    if not input_is_adv:
        if not use_test_set:
            output_dir = args.output_dir + '/' + args.role + '/' + args.dataset + '/' + 'orig/train/' + args.method + '/' + str(args.class_idx) + '/'
        else:
            output_dir = args.output_dir + '/' + args.role + '/' + args.dataset + '/' + 'orig/test/' + args.method + '/' + str(args.class_idx) + '/'
    else:
        output_dir = args.output_dir + '/' + args.role + '/' + args.dataset + '/' + 'adv/' + args.attack_method + '/' + args.method + '/from_' + str(args.adv_src_class_idx) + '/'
